...
const testUsers = [
  ...
  { "id": "roCGOruDxAf1Aa9CXaJi", "userName": "oguzhan", "password": "123456" }
];
...
describe('LoginScreen Testleri', () => {
    test('Giriş Yap butonuna tıklandığında handleLogin fonksiyonunu çağırmalıdır.', async () => {
      ...
      fireEvent.changeText(usernameInput, 'oguzhan');
      fireEvent.changeText(passwordInput, '123456');
  
      fireEvent.press(loginButton);
  
      await waitFor(() => {
        expect(api.checkUserExists).toHaveBeenCalledWith('oguzhan', '123456');
      });
